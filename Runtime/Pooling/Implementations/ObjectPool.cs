...
namespace EasyToolkit.Core.Pooling.Implementations
{
    ...
    internal sealed class ObjectPool<T> : PoolBase<T>, IObjectPool<T> where T : class, new()
    {
        ...
        private readonly ObjectPoolConfiguration<T> _configuration;
        ...
        {
            if (_configuration.EnablePoolItemCallbacks && instance is IPoolObject poolObject)
            {
                poolObject.OnRent();
            }
