...
namespace EasyToolkit.Core.Reflection
{
    ...
    public static class AccessorBuilderExtensions
    {
        ...
        public static StaticGetter<TValue> BuildStaticGetter<TValue>(this AccessorBuilder builder, Type targetType)
        {
        ...
        public static InstanceGetter<TInstance, TValue> BuildInstanceGetter<TInstance, TValue>(
            this AccessorBuilder builder, Type targetType)
        {
        ...
        /// </remarks>
        public static StaticSetter<TValue> BuildStaticSetter<TValue>(this AccessorBuilder builder, Type targetType)
        {
