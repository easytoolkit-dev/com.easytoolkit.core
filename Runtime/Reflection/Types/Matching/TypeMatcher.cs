...
namespace EasyToolkit.Core.Reflection.Implementations
{
    ...
    public sealed class TypeMatcher : ITypeMatcher
    {
        ...
        /// </summary>
        private readonly List<ITypeMatchRule> _matchRules = new();

        private List<TypeMatchCandidate> _typeMatchCandidates;

        private readonly Dictionary<string, TypeMatchResult[]> _matchResultsCache = new();

        private readonly Dictionary<string, TypeMatchResult[]> _mergedResultsCache = new();
