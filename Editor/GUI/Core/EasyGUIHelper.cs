...
namespace EasyToolkit.Core.Editor
{
    public static class EasyGUIHelper
    {
        ...
        private static readonly StaticGetter<float> TopLevelLayoutMinHeightGetter;
        private static readonly StaticGetter<float> TopLevelLayoutMaxHeightGetter;
        private static readonly StaticGetter<float> ActualLabelWidthGetter;
        private static readonly StaticGetter<object> TopLevelLayoutGetter;
        private static readonly MethodInfo TopLevelLayoutCalcHeightMethod;
        private static readonly StaticGetter<float> ContextWidthGetter;
        private static readonly StaticSetter<float> ContextWidthSetter;
        private static readonly StaticGetter<Stack<float>> ContextWidthStackGetter;
        ...
        static EasyGUIHelper()
        {
            ...
            EditorWindowRectGetter = new AccessorBuilder("get.parent.screenPosition").BuildStaticGetter<Rect>(toolbarType);

            GUILayoutEntryRectGetter = new AccessorBuilder("rect").BuildInstanceGetter<object, Rect>(guiLayoutEntryType);
            CurrentWindowHasFocusGetter = new AccessorBuilder("current.hasFocus").BuildStaticGetter<bool>(guiViewType);

            GUIViewGetter = new AccessorBuilder("current").BuildStaticGetter<object>(guiViewType);
            ActualViewGetter = new AccessorBuilder("actualView").BuildInstanceGetter<object, EditorWindow>(HostViewType);

            TopLevelLayoutGetter = new AccessorBuilder("current.topLevel").BuildStaticGetter<object>(typeof(GUILayoutUtility));
            TopLevelLayoutRectGetter = new AccessorBuilder("current.topLevel.rect").BuildStaticGetter<Rect>(typeof(GUILayoutUtility));
            TopLevelLayoutMinHeightGetter = new AccessorBuilder("current.topLevel.minHeight").BuildStaticGetter<float>(typeof(GUILayoutUtility));
            TopLevelLayoutMaxHeightGetter = new AccessorBuilder("current.topLevel.maxHeight").BuildStaticGetter<float>(typeof(GUILayoutUtility));

            EditorScreenPointOffsetGetter = new AccessorBuilder("s_EditorScreenPointOffset").BuildStaticGetter<Vector2>(typeof(GUIUtility));
            ContextWidthGetter = new AccessorBuilder("contextWidth").BuildStaticGetter<float>(typeof(EditorGUIUtility));
            ...
            if (field != null)
                ContextWidthSetter = new AccessorBuilder("s_ContextWidth").BuildStaticSetter<float>(typeof(EditorGUIUtility));
            else
                ContextWidthStackGetter = new AccessorBuilder("s_ContextWidthStack").BuildStaticGetter<Stack<float>>(typeof(EditorGUIUtility));

            ActualLabelWidthGetter = new AccessorBuilder("s_LabelWidth").BuildStaticGetter<float>(typeof(EditorGUIUtility));
            ...
            GUILayoutEntriesCursorIndexGetter = new AccessorBuilder("current.topLevel.m_Cursor").BuildStaticGetter<int>(typeof(GUILayoutUtility));
            GUILayoutEntriesGetter = new AccessorBuilder("current.topLevel.entries").BuildStaticGetter<IList>(typeof(GUILayoutUtility));
        }
        ...
        public static EditorWindow CurrentWindow
        {
            get
            {
                ...
                return ActualViewGetter(ref view);
            }
        }
